...
var Token_lenguaje = require('./Token_lenguaje');

class Analisis_lexico{
 

   
    constructor(contenidoo) {
     ...
     //    console.log("estado-> "+ this.estado);
            ...
            switch(this.estado)
            {
                case 0:
                    if(banderaaux_levantada){
                      banderaaux_levantada=false;
                    ...
                    else if(charActual==='\\' && this.contenido_areaTexto[auxcaracter+1]==='n'){// \n
                        this.aceptarToken(54,"salto_linea!",this.fila,this.columna);
                        banderaaux_levantada=true;
                    }
                    else if(charActual==='\\' && this.contenido_areaTexto[auxcaracter+1]==='t'){//  \t
                        this.aceptarToken(54,"tabular!",this.fila,this.columna);
                        banderaaux_levantada=true;
                    }
                    else if(charActual==='\\' && this.contenido_areaTexto[auxcaracter+1]==='r'){// \r
                        this.aceptarToken(55,"retorno_carro!",this.fila,this.columna);
                        banderaaux_levantada=true;
                    }else if(charActual==='\\' && this.contenido_areaTexto[auxcaracter+1]==='\\'){// \\
                        this.aceptarToken(56,"diagonal!",this.fila,this.columna);
                        banderaaux_levantada=true;
                    }else if(charActual==='\\' && this.contenido_areaTexto[auxcaracter+1]==='"'){// \""
                        this.aceptarToken(57,"com_doble!",this.fila,this.columna);
                        banderaaux_levantada=true;
                    }else if(charActual==='\\' && this.contenido_areaTexto[auxcaracter+1]==='\''){// \'
                        this.aceptarToken(58,"com_simple!",this.fila,this.columna);
                        banderaaux_levantada=true;
                    }
                        ...
                        this.aceptarToken(59,"exponente!",this.fila,this.columna);
                    }else if(charActual==='%'){//multiplica
                        this.aceptarToken(60,"residuo!",this.fila,this.columna);
                        ...
                        this.aceptarToken(5,".",this.fila,this.columna);
                        ...
                        if(this.contenido_areaTexto[auxcaracter+1]==='%'||this.contenido_areaTexto[auxcaracter+1]==='^'||this.contenido_areaTexto[auxcaracter+1]==='='||this.contenido_areaTexto[auxcaracter+1]==='*'||this.contenido_areaTexto[auxcaracter+1]==='/'|| this.contenido_areaTexto[auxcaracter+1]===')' ||this.contenido_areaTexto[auxcaracter+1]===':' ||this.contenido_areaTexto[auxcaracter+1]==='-'||this.contenido_areaTexto[auxcaracter+1]==='+'||this.contenido_areaTexto[auxcaracter+1]==='<' || this.contenido_areaTexto[auxcaracter+1]==='>' || this.contenido_areaTexto[auxcaracter+1]==='!' || this.contenido_areaTexto[auxcaracter+1]==='&' || this.contenido_areaTexto[auxcaracter+1]==='|' ||this.contenido_areaTexto[auxcaracter+1]===' ' || this.contenido_areaTexto[auxcaracter+1]===','|| this.contenido_areaTexto[auxcaracter+1]==='\n' || this.contenido_areaTexto[auxcaracter+1]==='\t' || this.contenido_areaTexto[auxcaracter+1]===';'){
              ...
              //      console.log(this.contenido_areaTexto[auxcaracter+1]+"==="+" = " + this.contenido_areaTexto[auxcaracter+1]==='=');
                    if(this.contenido_areaTexto[auxcaracter+1]==='%'||this.contenido_areaTexto[auxcaracter+1]==='^'||this.contenido_areaTexto[auxcaracter+1]==='\\' || this.contenido_areaTexto[auxcaracter+1]==='\t'||this.contenido_areaTexto[auxcaracter+1]==='\n'||this.contenido_areaTexto[auxcaracter+1]===':' ||this.contenido_areaTexto[auxcaracter+1]==='.'||this.contenido_areaTexto[auxcaracter+1]==='-'||this.contenido_areaTexto[auxcaracter+1]==='+'||this.contenido_areaTexto[auxcaracter+1]==='<' || this.contenido_areaTexto[auxcaracter+1]==='>' || this.contenido_areaTexto[auxcaracter+1]==='!' || this.contenido_areaTexto[auxcaracter+1]==='&' || this.contenido_areaTexto[auxcaracter+1]==='|' ||this.contenido_areaTexto[auxcaracter+1]==='(' ||this.contenido_areaTexto[auxcaracter+1]==='{'||this.contenido_areaTexto[auxcaracter+1]===' ' || this.contenido_areaTexto[auxcaracter+1]===';' || this.contenido_areaTexto[auxcaracter+1]===',' || this.contenido_areaTexto[auxcaracter+1]==='\t' ||this.contenido_areaTexto[auxcaracter+1]==='=' || this.contenido_areaTexto[auxcaracter+1]===')'){
                      ...
                      */}else if(this.lexema==="for"){
                            ...
                            this.aceptarToken(61, this.lexema, this.fila, this.columna);
                        }else if(this.lexema==="import"){
                            this.aceptarToken(62, this.lexema, this.fila, this.columna);
                        }
                        else if(this.lexema==="System"){
                            this.aceptarToken(63, this.lexema, this.fila, this.columna);
                        }else if(this.lexema==="out"){
                            this.aceptarToken(64, this.lexema, this.fila, this.columna);
                        }
                        else if(this.lexema==="println"){
                            this.aceptarToken(65, this.lexema, this.fila, this.columna);
                        }
                        else{                          
               ...
               // console.log("estamos en el estado 5")
                    this.lexema+=charActual;
                //    console.log(this.lexema);
                 //   console.log(this.lexema);
                 //   console.log(this.lexema.startsWith("\"") && this.lexema.endsWith("\""));
                   ...
                   //    console.log("la llegue aqui");
                    //   console.log("el caracter es: "+this.contenido_areaTexto[auxcaracter-1] )
                        if(this.contenido_areaTexto[auxcaracter-1]==='\\'){
                            if(this.contenido_areaTexto[auxcaracter-2]==='\\'){
